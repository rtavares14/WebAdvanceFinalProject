<script>
    ...
    // Error object to hold error messages for each field
    let errors = {
        dateError: '',
        bidError: '',
        rateError: '',
    ...
    function saveCard() {
        ...
        if (validateForm()) {
            editedCard.actionStartingDate = editedCard.actionStartingDate;
            editedCard.auctionEndDate = editedCard.auctionEndDate;
    ...
    function validateForm() {
        ...
        // Validate Energy Type (must be selected)
